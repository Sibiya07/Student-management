...
Course.associate = (models) => {
  // Student association
  Course.belongsTo(models.User, { foreignKey: "Userid", as: "student" });
  models.User.hasMany(Course, { foreignKey: "Userid", as: "studentCourses" });
  
  // Creator association
  Course.belongsTo(models.User, { foreignKey: "Created_by", as: "creator" });
  models.User.hasMany(Course, { foreignKey: "Created_by", as: "coursesCreated" });
  
  // Updater association
  Course.belongsTo(models.User, { foreignKey: "Updated_by", as: "updater" });
  models.User.hasMany(Course, { foreignKey: "Updated_by", as: "coursesUpdated" });
  
  // Approver association
  Course.belongsTo(models.User, { foreignKey: "Approved_by", as: "approver" });
  models.User.hasMany(Course, { foreignKey: "Approved_by", as: "coursesApproved" });
  
  // Marksheet association
  Course.hasMany(models.Marksheet, { foreignKey: 'Userid', sourceKey: 'Userid' });
};
